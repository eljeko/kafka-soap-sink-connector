...
public class SoapSinkConnectorTest {
    ...
    public void testSinkTasks() {
        ...
        assertEquals(FILENAME, taskConfigs.get(0).get(SoapSinkConnector.FILE_CONFIG));
    ...
    public void testSinkTasksStdout() {
        sinkProperties.remove(SoapSinkConnector.FILE_CONFIG);
        connector.start(sinkProperties);
        List<Map<String, String>> taskConfigs = connector.taskConfigs(1);
        assertEquals(1, taskConfigs.size());
        assertNull(taskConfigs.get(0).get(SoapSinkConnector.FILE_CONFIG));
    }

    @Test
    public void testTaskClass() {
        connector.start(sinkProperties);
        assertEquals(SoapSinkTask.class, connector.taskClass());
    }
